 ...
 */
public class KumarThought extends JSONObject {
    ...
    /**
     * create a clone of a json object as a KumarThought object
     * @param json the 'other' thought, probably an exported and re-imported thought
     */
    public KumarThought(JSONObject json) {
        this();
     ...
     * @param matcher
     */
    public KumarThought(Matcher matcher) {
        this();
    ...
    @Deprecated
    public KumarThought(String metadata_name, String data_name) {
        super(true);
    ...
    public boolean equals(Object o) {
        if (!(o instanceof KumarThought)) return false;
        KumarThought t = (KumarThought) o;
        return this.getData().equals(t.getData());
    }
    
    public KumarThought setTimes(int t) {
        this.times = t;
        return this;
    }
    
    public KumarThought addTimes(int t) {
        this.times += t;
        return this;
    }
     ...
     * @return the thought
     */
    public KumarThought setOffset(int offset) {
     ...
     * @return the thought
     */
    public KumarThought setHits(int hits) {
     ...
     * @return the thought
     */
    public KumarThought setProcess(String processName) {
     ...
     * @return the thought
     */
    public KumarThought setQuery(String query) {
     ...
     * @return the thought
     */
    public KumarThought setScraperInfo(String scraperInfo) {
     ...
     * @return the thought
     */
    public KumarThought setData(JSONArray table) {
     ...
     * @return the thought
     */
    public KumarThought mergeData(JSONArray table1) {
     ...
     * @return the thought
     */
    public KumarThought addObservation(String featureName, String observation) {
     ...
     * @return the thought
     */
    public KumarThought addActions(List<KumarAction> actions) {
        JSONArray a = getActionsJSON();
        actions.forEach(action -> a.put(action.toJSONClone()));
        return this;
    }
    
    public KumarThought addAction(KumarAction action) {
        JSONArray a = getActionsJSON();
    ...
    public List<KumarAction> getActions() {
        List<KumarAction> actions = new ArrayList<>();
        getActionsJSON().forEach(action -> actions.add(new KumarAction((JSONObject) action)));
        return actions;
    }
    ...
    public static void main(String[] args) {
        KumarThought t = new KumarThought().addObservation("a", "letter-a");

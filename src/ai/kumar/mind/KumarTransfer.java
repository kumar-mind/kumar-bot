...
public class KumarTransfer {
     ...
     * @param mapping
     */
    public KumarTransfer(String mappingExpression) {
     ...
     * create a new json object. In the context of Kumar this is applied on choices from thought data
     * @param choice one 'row' of a KumarThought data array
     ...
     * @param choices the given set of json objects from the data object of a KumarThought

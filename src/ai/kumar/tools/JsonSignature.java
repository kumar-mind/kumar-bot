...
public class JsonSignature {
    ...
    public static void removeSignature(Map<String, byte[]> obj){
        if(obj.containsKey(signatureString)) obj.remove(signatureString);
    }
    ...
    public static boolean verify(Map<String, byte[]> obj, PublicKey key) throws SignatureException, InvalidKeyException {

        if(!obj.containsKey(signatureString)) throw new SignatureException("No signature supplied");
    ...
    public static boolean hasSignature(Map<String, byte[]> obj){
        return obj.containsKey(signatureString);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if(hasSignature(randomObj)) System.out.println("Verify 1: " + verify(randomObj,keyPair.getPublic()));
        if(hasSignature(randomObj2)) System.out.println("Verify 2: " + verify(randomObj,keyPair.getPublic()));

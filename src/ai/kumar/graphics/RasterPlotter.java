...
public class RasterPlotter {
    ...
    public void arcConnect(final int cx, final int cy, final int arcRadius, final double angle1, final double angle2, final boolean in,
        ...
        if (message != null && message.length() > 0) {
            ...
            PrintTool.print(this, xm, ym, 0, message.toUpperCase(), -1, false, intensityMessage);
        }
    }
    ...
    public static void demoPaint(final RasterPlotter m) {
        m.setColor(GREY);
        m.line(0,  70, 100,  70, 100); PrintTool.print(m, 0,  65, 0, "Grey", -1, false, 100);
        m.line(65, 0,   65, 300, 100);
        m.setColor(RED);
        m.line(0,  90, 100,  90, 100); PrintTool.print(m, 0,  85, 0, "Red", -1, false, 100);
        m.line(70, 0,   70, 300, 100);
        m.setColor(GREEN);
        m.line(0, 110, 100, 110, 100); PrintTool.print(m, 0, 105, 0, "Green", -1, false, 100);
        m.line(75, 0,   75, 300, 100);
        m.setColor(BLUE);
        m.line(0, 130, 100, 130, 100); PrintTool.print(m, 0, 125, 0, "Blue", -1, false, 100);
    ...
    public static ByteArrayOutputStream exportImage(final BufferedImage image, final String targetExt) {
    ...
    public ByteArrayOutputStream exportPng() {
        try {
            final ByteArrayOutputStream baos = new ByteArrayOutputStream();
    ...
    public final byte[] pngEncode(final int compressionLevel) throws IOException {
        if (this.frame == null) return exportImage(this.getImage(), "png").toByteArray();
        ...
        final int nCompressed = outBytes.size();
